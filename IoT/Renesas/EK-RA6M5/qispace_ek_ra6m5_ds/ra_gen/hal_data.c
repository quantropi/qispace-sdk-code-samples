...
/* Actual period: 0.67108864 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x10000,
  .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t) 10, .channel = 5, .p_callback = gpt_blink_callback,
...
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x2710,
  .duty_cycle_counts = 0x1388, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
gpt_instance_ctrl_t g_gpt_green_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_gpt_green_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_gpt_green_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT1_CAPTURE_COMPARE_B,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_gpt_green_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_gpt_green_cfg =
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x2710,
  .duty_cycle_counts = 0x1388, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Instance structure to use this module. */
const timer_instance_t g_gpt_green =
{ .p_ctrl = &g_gpt_green_ctrl, .p_cfg = &g_gpt_green_cfg, .p_api = &g_timer_on_gpt };
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x2710,
  .duty_cycle_counts = 0x1388, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
